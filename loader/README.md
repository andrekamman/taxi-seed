...
one table per year per type, page-compressed — entirely through DuckDB and the `mssql`
community extension. Idempotent: a month not loaded is appended; a complete year is skipped;
